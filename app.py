...
def render_result(result: SummaryResult, form_values: dict[str, object]) -> str:
    ...
    <header class="masthead">
      ...
      <div class="top-actions">
        ...
        <a class="ghost-link" href="/output/{html.escape(result.output_path.name)}" target="_blank" rel="noreferrer">Open Markdown</a>
      </div>
    </header>
    ...
    <section class="hero">
      <section class="hero-card">
        ...
        <div class="stats-grid">
          ...
          <div class="metric"><strong>{html.escape(str(result.output_path.name))}</strong><span>Saved file</span></div>
        </div>
      </section>
